...
namespace ABE.LTRIC.Infrastructure.Migrations
{
    ...
    [Migration("20221226184855_AddEffictiveDateToSettings")]
    partial class AddEffictiveDateToSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABE.LTRIC.Core.Entities.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABE.LTRIC.Core.Entities.Doc", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABE.LTRIC.Core.Entities.DocDtl", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("RecoveredFromCompany")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ABE.LTRIC.Core.Entities.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABE.LTRIC.Core.Entities.Doc", b =>
                {
                    b.HasOne("ABE.LTRIC.Core.Entities.Company", "Company")
                        .WithMany("Docs")
            ...
            modelBuilder.Entity("ABE.LTRIC.Core.Entities.DocDtl", b =>
                {
                    b.HasOne("ABE.LTRIC.Core.Entities.Doc", null)
                        .WithMany("DocDtls")
                        .HasForeignKey("DocId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
